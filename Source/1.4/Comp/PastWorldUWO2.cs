...
namespace SaveOurShip2
{
    ...
    public class PastWorldUWO2 : WorldComponent
    {
        ...
        public Dictionary<int, PawnSpaceModifiers> PawnsInSpaceCache = new Dictionary<int, PawnSpaceModifiers>();
        ...
        public PawnSpaceModifiers AddPawnToSpaceCache(Pawn pawn)
        {
            PawnSpaceModifiers pawnSpaceModifiers = new PawnSpaceModifiers(pawn);
            this.PawnsInSpaceCache[pawn.thingIDNumber] = pawnSpaceModifiers;
            return pawnSpaceModifiers;
        }

        public PawnSpaceModifiers GetPawnSpaceModifiersCache(Pawn pawn)
        {
            if (this.PawnsInSpaceCache.ContainsKey(pawn.thingIDNumber))
            {
                return this.PawnsInSpaceCache[pawn.thingIDNumber];
            }
            else
            {
                return null;
        ...
        public void RemovePawnFromSpaceCache(Pawn pawn)
        {
            if (this.PawnsInSpaceCache.ContainsKey(pawn.thingIDNumber))
            {
                this.PawnsInSpaceCache.Remove(pawn.thingIDNumber);
            }
        }
    }
}
