...
namespace SaveOurShip2
{
	public class Graphic_SingleOnOffEmpty : Graphic
	{
		...
		public override void Init(GraphicRequest req)
		{
			...
			MaterialRequest req4 = default(MaterialRequest);
			req4.mainTex = ContentFinder<Texture2D>.Get(req.path + "_empty", true);
			req4.shader = req.shader;
			req4.color = this.color;
			req4.colorTwo = this.colorTwo;
			req4.renderQueue = req.renderQueue;
			req4.shaderParameters = req.shaderParameters;
			this.matEmpty = MaterialPool.MatFrom(req4);
		}

		public override Graphic GetColoredVersion(Shader newShader, Color newColor, Color newColorTwo)
		{
			return GraphicDatabase.Get<Graphic_SingleOnOffEmpty>(this.path, newShader, this.drawSize, newColor, newColorTwo, this.data);
		}

		public override Material MatAt(Rot4 rot, Thing thing = null)
		{
			if (thing.TryGetComp<CompBuildingConsciousness>()?.Consciousness == null)
				return this.matEmpty;
