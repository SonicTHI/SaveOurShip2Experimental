...
namespace SaveOurShip2
{
	public class JobGiver_RepairShields : ThinkNode
	{
		...
		public override ThinkResult TryIssueJobPackage(Pawn pawn, JobIssueParams jobParams)
		{
			...
			{
				foreach (CompShipHeatShield shield in mapComp.Shields.Where(s => !(s.parent is VehiclePawn) && s.breakComp.BrokenDown && s.parent.Faction == pawn.Faction && pawn.CanReserveAndReach(s.parent, PathEndMode.ClosestTouch, Danger.Deadly)))
				{
