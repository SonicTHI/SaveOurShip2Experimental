...
{
	public class SymbolResolver_ShipEdgeWallsTriangle2 : SymbolResolver
	{
		public override void Resolve(ResolveParams rp)
		{
			...
			IntVec3 lineStart;
			if (topHalf)
				lineStart = new IntVec3(rp.rect.minX + 1, 0, rp.rect.minZ - 1);
			else
				lineStart = new IntVec3(rp.rect.minX + 1, 0, rp.rect.minZ + 1);
			int ecks = 0;
			int zee = 0;
			while(ecks<rp.rect.Width-2)
			{
				this.TrySpawnWall(new IntVec3(rp.rect.minX + rp.rect.Width - 1, 0, lineStart.z + zee),rp);
