...
namespace SaveOurShip2
{
	...
	class CompShuttleCosmetics : ThingComp
	{
		...
		public static Dictionary<ThingDef, CompProps_ShuttleCosmetics> GraphicsToResolve = new Dictionary<ThingDef, CompProps_ShuttleCosmetics>();

		public CompProps_ShuttleCosmetics Props
		{
			get
			{
				return (CompProps_ShuttleCosmetics)this.props;
			}
		}
		...
		public static void ChangeShipGraphics(ThingWithComps parent, CompProps_ShuttleCosmetics Props, bool triggeredByChange = false)
		{
